...
def args_config():
    ...
    parse.add_argument('--genre', choices=['conll_2002', 'conll_2003'], default='conll_2003', help='the dataset type')
    ...
    parse.add_argument('--bert_embed_dim', type=int, default=300, help='feature size of bert inputs')
